...
func init() {
	...
	readErrorFuncMap[ValueErrorCode] = readValueError
	readErrorFuncMap[WindowErrorCode] = readWindowError
	readErrorFuncMap[PixmapErrorCode] = readPixmapError
	readErrorFuncMap[AtomErrorCode] = readAtomError
	readErrorFuncMap[CursorErrorCode] = readCursorError
	readErrorFuncMap[FontErrorCode] = readFontError
	readErrorFuncMap[MatchErrorCode] = readMatchError
	readErrorFuncMap[DrawableErrorCode] = readDrawableError
	readErrorFuncMap[AccessErrorCode] = readAccessError
	readErrorFuncMap[AllocErrorCode] = readAllocError
	readErrorFuncMap[ColormapErrorCode] = readColormapError
	readErrorFuncMap[GContextErrorCode] = readGContextError
	readErrorFuncMap[IdChoiceErrorCode] = readIdChoiceError
	readErrorFuncMap[NameErrorCode] = readNameError
	readErrorFuncMap[LengthErrorCode] = readLengthError
	readErrorFuncMap[ImplementationErrorCode] = readImplementationError
}
